...
Description: Social Share Motivator makes your pages barely visible (darker) urging your visitors to share your blog on Facebook, Twitter or Google Plus, if they want to enjoy full access. You can check the <a href="http://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/" target="_blank">Home Page</a> for more information.
Version: 3.0
...
class socialsharemotivator_class {
  ...
  function front_header() {
	...
	if (empty($showHome) && is_home()) return;	
	...
	if ( ! is_page( $showSingpages ) && empty($showPage) && is_page() ) return;
		...
		if($cookie_value != "1"){
			...
			<div id="sosharemotivator" style="display:none;">
				...
				<div class="ssm-author"><a href="http://www.thefreewindows.com" target="_blank">Powered by TheFreeWindows</a></div>	
				</div>
			<script type="text/javascript">			  
...
if(isset($sosharemotivator)) { 
	function plugin_settings_link($links) { 
		$settings_link = '<a href="options-general.php?page='.SOCIAL_SHARE_MOTIVATOR_PLUGINOPTIONS_ID.'">Settings</a> | <a href="http://www.thefreewindows.com/15875/social-share-motivator-fqa/">FQA</a>'; 
