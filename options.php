...
<input type="text" class="regular-text code" value="<?php echo get_option('socialsharemotivatorpo_singpages');?>" id="socialsharemotivatorpo_singpages" name="socialsharemotivatorpo_singpages" style="box-shadow: 2px 2px 7px #DBDBDB; -webkit-box-shadow: 2px 2px 7px #DBDBDB; -moz-box-shadow: 2px 2px 7px #DBDBDB;margin-top:12px;font-size:19px;">
				...
				<tr valign="top">
					...
					<td>
					Clear the "Posts" option above, then write here the <a href="http://www.thefreewindows.com/15950/find-id-wordpress-post-page/" target="_blank" style="text-decoration:none;color:#2b95ff;">ID number(s)</a> of post(s) to lock<br>
...
<input type="text" class="regular-text code" value="<?php echo get_option('socialsharemotivatorpo_singposts');?>" id="socialsharemotivatorpo_singposts" name="socialsharemotivatorpo_singposts" style="box-shadow: 2px 2px 7px #DBDBDB; -webkit-box-shadow: 2px 2px 7px #DBDBDB; -moz-box-shadow: 2px 2px 7px #DBDBDB;margin-top:12px;font-size:19px;">						
				...
				<tr valign="top">
					...
					<td style="background:#F9F9F9;">
				To disable Motivator on specific pages, make sure there is a checkmark in the general "Pages" option above, then write here <a href="http://www.thefreewindows.com/15950/find-id-wordpress-post-page/" target="_blank" style="text-decoration:none;color:#2b95ff;">the ID number(s)</a> of page(s) <b>not</b> to be locked<br>
...
<input type="text" class="regular-text code" value="<?php echo get_option('socialsharemotivatorpo_singpagesdis');?>" id="socialsharemotivatorpo_singpagesdis" name="socialsharemotivatorpo_singpagesdis" style="box-shadow: 2px 2px 7px #DBDBDB; -webkit-box-shadow: 2px 2px 7px #DBDBDB; -moz-box-shadow: 2px 2px 7px #DBDBDB;margin-top:12px;font-size:19px;">
				...
				<tr valign="top">
					...
					<td>
				Make sure there is a checkmark in the general "Posts" option above and write here the <a href="http://www.thefreewindows.com/15950/find-id-wordpress-post-page/" target="_blank" style="text-decoration:none;color:#2b95ff;">ID number(s)</a> of post(s) that should <b>not</b> be locked<br>
...
<div style="margin-top:55px;" align="center"> &nbsp;  &nbsp;  &nbsp; <a style="color:silver;text-decoration:none;font-weight:bold;font-size:27px;letter-spacing:4px;" href="http://www.thefreewindows.com/" target="_blank">TheFreeWindows</a></div>
