...
-->
				...
				<tr valign="top">
					...
					<td>
						<input type="text" class="regular-text code" value="<?php echo get_option('socialsharemotivatorpo_sitedesc');?>" id="socialsharemotivatorpo_url" name="socialsharemotivatorpo_sitedesc">								
